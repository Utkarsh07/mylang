...
func extendFunctionEnvironment(fn *object.Function, arguments []object.Object) *object.Environment {
	env := object.NewEnclosedEnvironment(fn.Env)

	for pid, parameter := range fn.Parameters {
		env.Set(parameter.Value, arguments[pid])
	}
	return env
}
...
func applyFunction(fn object.Object, arguments []object.Object) object.Object {
	...
	case *object.Function:
		extendedEnvironment := extendFunctionEnvironment(fn, arguments)
